...
**Latent Jamming** is an improvisation practice with real-time capable neural audio models that embraces concepts of algorithmic and/ or generative composition techniques. \
Read more about concept and practice [here](https://martstil.de/concepts/latent-jamming). \
